...
import { getQuizzes, getQuizById, getSharedQuiz, createDemoQuiz, createQuiz, cloneQuiz, updateQuiz, shareQuiz, saveAnswers, removeQuiz, unshareQuiz } from '../controllers/quizController.js';
...
quizRouter.post('/demo', createDemoQuiz);
